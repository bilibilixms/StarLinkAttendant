...
-- 版本：v2.0（Demo 单店版）
-- 生成日期：2026-07-12
-- 基于 database-design.md v2.0 / SQL.md v2.0
--
-- 说明：
...
--   4. 支付方式仅支持：1-现金 2-会员余额（Demo 项目不接入真实第三方支付）。
--   5. 注册来源仅支持：1-前台 2-后台导入（无小程序渠道）。
-- ============================================================

-- ============================================================
-- 1. 数据库创建
-- ============================================================
CREATE DATABASE IF NOT EXISTS `starlink_attendant`
...
DROP TABLE IF EXISTS `tariff_rate`;
DROP TABLE IF EXISTS `reservation`;
DROP TABLE IF EXISTS `session_timing`;

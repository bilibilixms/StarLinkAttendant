...
/** 解析 SSE 文本块，返回事件对象数组 */
function parseSSEBlock(block: string): any[] {
  const events: any[] = []
 ...
 * @param url 请求地址
 * @param body 请求体
 * @param handlers { onEvent, onError, onComplete }
 * @returns {{ abort: Function }}
 */
export function startSSE(url: string, body: any, handlers: SSEHandlers): { abort: () => void } {
